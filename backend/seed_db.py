...
def seed_data(db: Session):
    if not db.query(Agent).first():
        agents = [
            ...
            Agent(agentname="Yaroslav01A1808", password="$2b$12$LHtHlmPoMOZxwQ4w5.sweei9A7KDsmdHW5Oq2IC2Kedfn4lyhyUWW", persona="LenaLindberg"),
            Agent(agentname="Snezhana02B2818", password="$2b$12$LHtHlmPoMOZxwQ4w5.sweei9A7KDsmdHW5Oq2IC2Kedfn4lyhyUWW", persona="LenaLindberg"),
            Agent(agentname="Maksim03C3828", password="$2b$12$LHtHlmPoMOZxwQ4w5.sweei9A7KDsmdHW5Oq2IC2Kedfn4lyhyUWW", persona="LenaLindberg"),
            Agent(agentname="Mark04D4838", password="$2b$12$LHtHlmPoMOZxwQ4w5.sweei9A7KDsmdHW5Oq2IC2Kedfn4lyhyUWW", persona="LenaLindberg"),
            Agent(agentname="Nsikanabasi05E5848", password="$2b$12$LHtHlmPoMOZxwQ4w5.sweei9A7KDsmdHW5Oq2IC2Kedfn4lyhyUWW", persona="LenaLindberg"),
